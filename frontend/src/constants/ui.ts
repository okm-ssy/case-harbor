...
export const UI_CONSTANTS = {
  // 高さとマージン
  CELL_MIN_HEIGHT: '5.5rem',
  CELL_MAX_HEIGHT: '5.5rem',
  ...
  SPEC_CELL_WIDTH: '30%',
  SPEC_CELL_MIN_WIDTH: '200px',
  PRECOND_CELL_WIDTH: '25%',
  PRECOND_CELL_MIN_WIDTH: '180px',
  STEPS_CELL_WIDTH: '30%',
  STEPS_CELL_MIN_WIDTH: '200px',
  VERIFY_CELL_WIDTH: '25%',
  VERIFY_CELL_MIN_WIDTH: '180px',
  ACTIONS_CELL_WIDTH: '5%',
  ACTIONS_CELL_MIN_WIDTH: '60px',
